...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->нарисоватьToolStripMenuItem->Size = System::Drawing::Size(146, 22);
			...
			this->скрытьToolStripMenuItem1->Size = System::Drawing::Size(146, 22);
			...
			this->переместитьToolStripMenuItem1->Size = System::Drawing::Size(146, 22);
			...
			this->сместитьToolStripMenuItem->Size = System::Drawing::Size(146, 22);
			...
			// 
			this->прямоугольникToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) {this->нарисToolStripMenuItem1});
			...
			this->нарисToolStripMenuItem1->Size = System::Drawing::Size(139, 22);
			...
			// 
			this->newToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {this->нарисоватьToolStripMenuItem1, 
				this->сместитьГруппуToolStripMenuItem});
